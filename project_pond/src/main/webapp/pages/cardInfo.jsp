...
<div class=donorinfo>
 <div class="form-group">
        ...
        <div class="form-group">
            <label for="donorBirth" class="form-label">생년월일</label>
            <input type="text" name="donorBirth" id="donorBirth" placeholder="생년월일" class="form-input" maxlength="8">
            <span id="birthError" class="error-message">생년월일을 입력해주세요</span>
        </div>

        <div class="form-group">
            <label for="donorPhone" class="form-label">전화번호</label>
            <input type="tel" name="donorPhone" id="donorPhone" placeholder="전화번호" class="form-input" maxlength="11">
            <span id="phoneError" class="error-message">전화번호를 입력해주세요</span>
        </div>

        <div class="form-group">
            <label for="donorEmail" class="form-label">이메일</label>
	...
	<div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="cardNumber" id="cardNumber" placeholder="카드번호" class="form-input">
            <span id="cardNumberError" class="error-message">카드번호를 입력해주세요</span>
        </div>

        <div class="form-group">
            <label for="cardPassword" class="form-label">카드 비밀번호 2자리</label>
            <input type="text" name="cardPassword" id="cardPassword" placeholder="카드 비밀번호 2자리" maxlength="2" class="form-input">
            <span id="cardPasswordError" class="error-message">카드 비밀번호 앞자리2개를 입력해주세요</span>
        </div>

        <div class="form-group">
            <label for="cardExpYear" class="form-label">카드 유효기간</label>
            <select name="cardExpYear" id="cardExpYear" class="form-input">
        ...
        <div class="form-group">
            <label for="cardExpMonth" class="form-label">카드 유효기간</label>
            <select name="cardExpMonth" id="cardExpMonth" class="form-input">
...
<script>
    ...
    function payInfoCheck(htmlForm) {
         ...
         var fields = [
             ...
             { input: cardExpYear, error: cardExpirationError },
             { input: cardExpMonth, error: cardExpirationError }
         ];
