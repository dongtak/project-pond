...
<div class=donorinfo>
 <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="donorBirth" id="donorBirth" placeholder="생년월일" class="form-input">
            <span id="birthError" class="error-message">생년월일을 입력해주세요</span>
        </div>

        <div class="form-group">
            <label for="donorPhone" class="form-label">전화번호</label>
            <input type="tel" name="donorPhone" id="donorPhone" placeholder="전화번호" class="form-input">
