...
$('#new-password').on('change', function() {
	if($('#new-password').val() !== "") {
		$('#error-password').hide();
		$('#new-password').css('border-color', '#1E3269');
	}
});
...
$('#email').on('change', function() {
	if($('#email').val() !== "") {
		$('#error-email').hide();
		$('#email').css('border-color', '#1E3269');
	}
});
$('#name').on('change', function() {
	if($('#name').val() !== "") {
		$('#error-name').hide();
		$('#name').css('border-color', '#1E3269');
	}
});
